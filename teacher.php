          ...
          <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
              <div class="card h-100 bg-light shadow p-1" id="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Physics <a href="tcourse.php" class="btn btn-primary" style="float: right;">View Course</a></h5>
            ...
            <div class="col">
              <div class="card h-100 bg-light shadow p-1" id="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Chemistry <a href="tcourse.php" class="btn btn-primary" style="float: right;">View Course</a> </h5>
            ...
            <div class="col">
              <div class="card h-100 bg-light shadow p-1" id="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Biology <a href="tcourse.php" class="btn btn-primary" style="float: right;">View Course</a></h5>
            ...
            <div class="col">
              <div class="card h-100 bg-light shadow p-1" id="card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Mathematics <a href="tcourse.php" class="btn btn-primary" style="float: right;">View Course</a></h5>
            ...
            <div class="col">
                <div class="card h-100 bg-light shadow p-1" id="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">Computer Science <a href="tcourse.php" class="btn btn-primary" style="float: right;">View Course</a></h5>
              ...
              <div class="col">
                <div class="card h-100 bg-light shadow p-1" id="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">Social Science <a href="tcourse.php" class="btn btn-primary" style="float: right;">View Course</a></h5>
              ...
              <div class="col">
                <div class="card h-100 bg-light shadow p-1" id="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title"><?php echo $cname; ?> <a href="tcourse.php" class="btn btn-primary" style="float: right;">View Course</a></h5>
...
$conn = mysqli_connect($server , $username , $password , $dbname);
 ...
 <p class="stars">Stars:<?php echo $rows['stars']; ?></p>
