   ...
   <body>
      <div class="wrapper">
         ...
         <nav id="sidebar">
            ...
            <ul class="list-items">
               <li><a href="student.php"><i class="fas "></i>Home</a></li>
               <li><a href="#"><i class="fas "></i>Uploads</a></li>
               <li><a href="#"><i class="fas "></i>Assignments</a></li>
               <li><a href="review.html"><i class="fas "></i>Review</a></li>
            </ul>
         </nav>
      </div>
      ...
      <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0 " >
                <li><a href="student.php" class="nav-link px-4 link-dark" id="mynav">Dashboard</a></li>
      ...
      <div class="view">
        ...
        <a href="#" class="btn btn-primary card-button-insert" data-bs-toggle="modal" data-bs-target="#uploadimage">Upload assignment</a>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form id="modalform1" action="uploadassign.php" method="post" enctype="multipart/form-data">
